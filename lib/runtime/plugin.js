...
const createCustomHead = (originalHead, origin) => function customHead () {
   ...
   */
  if (this.$isAMP) {
    var  disableAmpCanonical= true //TODO: make this an option variable before merging into main lib
    if (!disableAmpCanonical && !head.link.find(l => l.rel === 'canonical' || l.hid === 'canonical')) {
